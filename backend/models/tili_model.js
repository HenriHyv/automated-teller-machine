...
const Tili = {
  ...
  getById: function(id, callback) {
    return db.query('SELECT SaldoDebit, SaldoCredit, DATE_FORMAT(pvm,"%d.%m.%Y") as pvm, TapahtumaNimi, SummaDebit, SummaCredit FROM Tilitapahtumat JOIN Tili ON Tilitapahtumat.idTili=Tili.idTili JOIN Kortti ON Tili.idTili=Kortti.idTili WHERE Kortti.idKortti=? ORDER BY idTilitapahtumat DESC;', [id], callback);
  },
